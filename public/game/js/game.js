...
var userId = queryString.substring(8);
console.log('This is the player id ', userId);
    ...
    console.log('I am trying to save the game');
    console.log(window.location.search);
    console.log('This is the game score', score);
   window.location.href = "http://localhost:8000/savegame?userId=" +userId + "&score=" +score;
}
