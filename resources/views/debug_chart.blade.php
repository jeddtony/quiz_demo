...
<body>
    ...
    <div class="counter col_fourth" style="margin-top: 50px">
        ...
        <h2 class="timer count-title count-number" data-to="{{$playerCount}}" data-speed="1500"></h2>
        <p class="count-text ">Total Number of Players</p>
      </div>
        ...
        <div class="table-cell">
          ...
          <ul class="leader">
			...
			<h2>{{ $allPlayer->name }} <span class="number">{{ $allPlayer->score }}</span></h2>
			</li>
			@endforeach
            <!-- <li>
